require(['jquery','Codazon_ProductFilter/js/lightslider.min'], function($) {
    $.widget('codazon.verticalgallery', {
        ...
        _createSlider: function () {
            ...
            $(config.images).each(function (i,img) {
                html += '<li class="item"><a href="'+img.large+'"><img class="img-responsive" src="'+img.small+'" width="'+img.width+'" height="'+img.height+'" /></a></li>'
            });
            html += '</ul>';
            self.slider = $(html);
