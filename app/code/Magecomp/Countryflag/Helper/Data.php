<?php
namespace Magecomp\Countryflag\Helper;

use Magento\Store\Model\ScopeInterface;

class Data extends \Magento\Framework\App\Helper\AbstractHelper
{
    CONST ENABLED = 'sms/countryflag/enable';
    CONST DETECT_BY_IP = 'sms/countryflag/detect_by_ip';
    CONST DETECT_BY_DEFAULT_COUNTRY = 'sms/countryflag/defaultcountry';
    CONST VALIDATE_PHONE = 'sms/countryflag/validate_phone';
    ...
    {
        return $this->scopeConfig->getValue(self::DETECT_BY_IP,
            ScopeInterface::SCOPE_STORE,
            $this->getStoreid());
    }
    ...
    {
        return $this->scopeConfig->getValue(self::DETECT_BY_DEFAULT_COUNTRY,
            ScopeInterface::SCOPE_STORE,
            $this->getStoreid());
    }
    ...
    {
        return $this->scopeConfig->getValue(self::VALIDATE_PHONE,
            ScopeInterface::SCOPE_STORE,
            $this->getStoreid());
    }
    ...
    {
        if ($this->isEnabled()) {
            $template = 'Magecomp_Countryflag::form/edit.phtml';
        } else {
