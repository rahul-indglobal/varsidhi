...
namespace Lof\Rma\Model\ResourceModel\Item;

/**
 * @method \Lof\Rma\Model\Item getFirstItem()
 * @method \Lof\Rma\Model\Item getLastItem()
 * @method \Lof\Rma\Model\ResourceModel\Item\Collection|\Lof\Rma\Model\Item[] addFieldToFilter
 * @method \Lof\Rma\Model\ResourceModel\Item\Collection|\Lof\Rma\Model\Item[] setOrder
 */
class Collection extends \Magento\Framework\Model\ResourceModel\Db\Collection\AbstractCollection
{
    ...
    {
        $this->_init('Lof\Rma\Model\Item', 'Lof\Rma\Model\ResourceModel\Item');
    }
    ...
    protected function initFields()
    {
        $select = $this->getSelect();
        $select->joinLeft(
            ['reason' => $this->getTable('lof_rma_reason')],
            'main_table.reason_id = reason.reason_id',
            ['reason_name' => 'reason.name']
        );
        $select->joinLeft(
            ['resolution' => $this->getTable('lof_rma_resolution')],
            'main_table.resolution_id = resolution.resolution_id',
            ['resolution_name' => 'resolution.name']
        );
        $select->joinLeft(
            ['condition' => $this->getTable('lof_rma_condition')],
