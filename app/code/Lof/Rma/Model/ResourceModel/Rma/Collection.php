...
/**
 * @method \Lof\Rma\Model\Rma getFirstItem()
 * @method \Lof\Rma\Model\Rma getLastItem()
 * @method \Lof\Rma\Model\ResourceModel\Rma\Collection|\Lof\Rma\Model\Rma[] addFieldToFilter
 * @method \Lof\Rma\Model\ResourceModel\Rma\Collection|\Lof\Rma\Model\Rma[] setOrder
 */
class Collection extends \Magento\Framework\Model\ResourceModel\Db\Collection\AbstractCollection
{
    ...
    public function __construct(
        ...
        \Lof\Rma\Model\ResourceModel\Status\CollectionFactory $statusCollectionFactory,
    ...
    {
        $this->_init('Lof\Rma\Model\Rma', 'Lof\Rma\Model\ResourceModel\Rma');
    }
    ...
    {
        $this->getSelect()
            ->where("EXISTS (SELECT * FROM `{$this->getTable('lof_rma_rma_store')}`
                AS `rma_store_table`
    ...
    {
        $this->getSelect()
            ->where("EXISTS (SELECT * FROM `{$this->getTable('lof_rma_rma_order')}`
                AS `rma_order_table`
    ...
    {
        $this->getSelect()
            ->where("EXISTS (SELECT * FROM `{$this->getTable('lof_rma_rma_creditmemo')}`
