...
class Rma extends \Magento\Framework\Model\ResourceModel\Db\AbstractDb
{
    ...
    {
        $this->_init('lof_rma_rma', 'rma_id');
    }

    /**
     * @param \Magento\Framework\Model\AbstractModel $object
     *
     * @return \Magento\Framework\Model\AbstractModel|\Lof\Rma\Model\Rma
     */
    protected function loadStoreIds(\Magento\Framework\Model\AbstractModel $object)
    {
        /* @var  \Lof\Rma\Model\Rma $object */
        $select = $this->getConnection()->select()
            ->from($this->getTable('lof_rma_rma_store'))
    ...
    protected function saveStoreIds($object)
    {
        ...
        $this->getConnection()->delete($this->getTable('lof_rma_rma_store'), $condition);
        foreach ((array)$object->getStoreId() as $id) {
            ...
            $this->getConnection()->insert(
                $this->getTable('lof_rma_rma_store'),
                $objArray
            );
        }
    }
