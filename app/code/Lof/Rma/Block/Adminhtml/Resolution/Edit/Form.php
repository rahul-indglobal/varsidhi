...
namespace Lof\Rma\Block\Adminhtml\Resolution\Edit;
...
class Form extends \Magento\Backend\Block\Widget\Form
{
    ...
    protected function _prepareForm()
    {
        ...
        if ($this->_isAllowedAction('Lof_Rma::rma_dictionary_resolution')) {
        ...
        $fieldset->addField('code', 'text', [
            ...
            'disabled' => $resolution->getCode() == '' ? $isElementDisabled : true,
        ]);
