        ...
        if ($this->items === null) {
            $items = [
                'rma' => [
                    ...
                    'resource' => 'Lof_Rma::rma_rma',
                    'child'    => [
                        'newAction' => [
                            'title'    => __('New RMA'),
                            'url'      => $this->getUrl('*/rma/add'),
                            'resource' => 'Lof_Rma::rma_edit',
                           ]
                       ]
                ],
                'status' => [
                    ...
                    'resource' => 'Lof_Rma::rma_dictionary_status',
                    'child'    => [
                        'newAction' => [
                            'title'    => __('New Status'),
                            'url'      => $this->getUrl('*/status/add'),
                            'resource' => 'Lof_Rma::status_edit',
                           ]
                       ]
                ],
                 'reason' => [
                    ...
                    'resource' => 'Lof_Rma::rma_dictionary_reason',
                    'child'    => [
                        'newAction' => [
                            'title'    => __('New Reason'),
                            'url'      => $this->getUrl('*/reason/add'),
                            'resource' => 'Lof_Rma::reason_edit',
                           ]
                       ]
                ],
                'resolution' => [
                    ...
                    'resource' => 'Lof_Rma::rma_dictionary_resolution',
                    'child'    => [
                        'newAction' => [
                            'title'    => __('New Reason'),
                            'url'      => $this->getUrl('*/resolution/add'),
                            'resource' => 'Lof_Rma::resolution_edit',
                           ]
                       ]
                ],
                'condition' => [
                    ...
                    'resource' => 'Lof_Rma::rma_dictionary_condition',
                    'child'    => [
                        'newAction' => [
                            'title'    => __('New Condition'),
                            'url'      => $this->getUrl('*/condition/add'),
                            'resource' => 'Lof_Rma::condition_edit',
                           ]
                       ]
                ],
                'rule' => [
                    ...
                    'resource' => 'Lof_Rma::rma_rule',
                    'child'    => [
                        'newAction' => [
                            'title'    => __('New Rules'),
                            'url'      => $this->getUrl('*/rule/add'),
                            'resource' => 'Lof_Rma::rule_edit',
                           ]
                       ]
                ],
                'report' => [
