...
class Message extends \Magento\Framework\App\Helper\AbstractHelper
{
    ...
    public function __construct(
        ...
        \Lof\Rma\Api\Repository\QuickResponseRepositoryInterface $quickResponseRepository,
        \Lof\Rma\Model\QuickResponseFactory                      $responseFactory,
    ...
    /**
     * @param \Lof\Rma\Model\QuickResponse $response
     * @return string
     */
    public function parseTemplate(\Lof\Rma\Model\QuickResponse $response)
    {
        ...
        if ($rma) {
            ...
            $data = [
                ...
                'user'     => $this->customerFactory->create()->load($rma->getUserId()),
            ];
    ...
    public function getConfirmationUrl($rma)
    {
        return $this->_urlBuilder->getUrl(
            'rma/rma/savemessage', ['id' => $rma->getId(), 'shipping_confirmation' => true]
        );
    }
