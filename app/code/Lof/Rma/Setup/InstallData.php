...
class InstallData implements InstallDataInterface
{
    ...
    public function install(ModuleDataSetupInterface $setup, ModuleContextInterface $context)
    {
        ...
        $setup->startSetup();
         $select = $setup->getConnection()->select()
            ...
            $select = $setup->getConnection()->insertFromSelect(
                $select,
                $setup->getTable('lof_rma_order_status_history'),
                [
                    'order_id',
                    'status',
                    'created_at'
        ...
        foreach ($data as $row) {
            $setup->getConnection()->insertForce($setup->getTable('lof_rma_condition'), $row);
        }
        ...
        foreach ($data as $row) {
            $setup->getConnection()->insertForce($setup->getTable('lof_rma_reason'), $row);
        }
        ...
        foreach ($data as $row) {
            $setup->getConnection()->insertForce($setup->getTable('lof_rma_resolution'), $row);
        }
...
// @codingStandardsIgnoreEnd
        foreach ($data as $row) {
            $setup->getConnection()->insertForce($setup->getTable('lof_rma_status'), $row);
        }
        $setup->endSetup();
    }
}
