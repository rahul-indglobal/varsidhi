...
abstract class Template extends \Magento\Backend\App\Action
{
    public function __construct(
        \Lof\Rma\Model\QuickResponseFactory $templateFactory,
    ...
    /**
     * @return \Lof\Rma\Model\QuickResponse
     */
    ...
    {
        return $this->context->getAuthorization()->isAllowed('Lof_Rma::rma_dictionary_template');
    }
