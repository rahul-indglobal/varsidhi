...
class Product extends Action
{
    ...
    {
        $resultPage->setActiveMenu('Lof_Rma::rma_report_product');
        $resultPage->getConfig()->getTitle()->prepend(__('Rma'));
        $resultPage->getConfig()->getTitle()->prepend(__('RMA Report By Product'));
        return $resultPage;
    }
    /**
     * {@inheritdoc}
    ...
    {
        return $this->context->getAuthorization()->isAllowed('Lof_Rma::rma_report_product');
    }
}