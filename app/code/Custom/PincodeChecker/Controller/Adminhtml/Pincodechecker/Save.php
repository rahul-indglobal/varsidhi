...
class Save extends \Magento\Backend\App\Action
{
    ...
    public function execute()
    {
        ...
        if ($data) {
            ...
            $model = $this->_objectManager->create('Custom\PincodeChecker\Model\Pincodechecker')->load($id);
            if (!$model->getId() && $id) {
            ...
            try {
                ...
                $this->dataPersistor->clear('Custom_pincodechecker_pincodechecker');
            ...
            $this->dataPersistor->set('Custom_pincodechecker_pincodechecker', $data);
