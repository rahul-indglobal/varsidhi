...
class Data extends \Magento\Framework\App\Helper\AbstractHelper
{
   ...
   public function getStaticBlockData() {
    ...
    public function haveBlockBefore($identifier = NULL,$blockModel = NULL) {
	 ...
	 public function haveBannerBefore($identifier = NULL,$blockModel = NULL) {
        //$stores = implode(',', $stores);
        $exist = $blockModel->getCollection()
	...
	public function haveBrandBefore($identifier = NULL,$blockModel = NULL) {
        //$stores = implode(',', $stores);
        $exist = $blockModel->getCollection()
    ...
    public function haveBlockPageBefore($identifier = NULL,$cmsModel = NULL) {
        //$stores = implode(',', $stores);
