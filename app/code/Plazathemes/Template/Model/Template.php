...
class Template
{
    ...
    public function saveConfigDesgin($helper,$store=NULL,$website = NULL,$demo_temp =null)
    {
      ...
      public function saveStaticBlock($store,$helper,$model) {
	...
	public function deleteCmsPageBlock($key = NULL, $stores = NULL, $cmsModel = NULL) {
		$cmsModel->load($key);
    ...
    public function deleteStaticBlock($key = NULL, $stores = NULL,$blockModel = NULL) {
        $blockModel->load($key);
	...
	public function deleteBanner($stores = null,$bannerModel = NULL) {
	...
	public function deleteBrand($stores = null,$brandModel = NULL) {
