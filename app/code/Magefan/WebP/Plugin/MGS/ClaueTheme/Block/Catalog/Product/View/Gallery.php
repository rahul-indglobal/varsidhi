...
namespace Magefan\WebP\Plugin\MGS\ClaueTheme\Block\Catalog\Product\View;
...
class Gallery
{
     ...
     * @return mixed
     */
    public function afterGetGalleryImages($gallery, $images)
    {
    ...
    {
        $imageTypes = ['small_image_url', 'medium_image_url', 'large_image_url', 'image_zoom'];
