...
return [
    'modules' => [
        ...
        'Magecomp_Base' => 1,
        'Magecomp_Sms' => 1,
        'Magecomp_Customprice' => 1,
        'Magecomp_Recentsalesnotification' => 1,
        ...
        'Razorpay_Magento' => 1,
        'Sparsh_AdvancedSorting' => 1,
        'Tawk_Widget' => 1,
        'Temando_ShippingRemover' => 1,
        'Varsidhi_Blousemeasurement' => 1,
        'Varsidhi_CategorySort' => 1,
        'Varsidhi_Gownmeasurement' => 1,
        'Varsidhi_Lehengameasurement' => 1,
        'Varsidhi_Salwarmeasurement' => 1,
        'Varsidhi_Videoshopping' => 1,
        'Wbcom_PincodeChecker' => 0,
        'Webkul_Rmasystem' => 1,
        'Webkul_StorePickup' => 0,
        'WeltPixel_Backend' => 1,
